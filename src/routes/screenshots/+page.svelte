<div on:click|stopPropagation={()=>{changeScreenshot(-1)}} class="image-btn material-icons unselectable">navigate_before</div>
...
<div on:click|stopPropagation={()=>{changeScreenshot(1)}} class="image-btn right material-icons unselectable">navigate_next</div>
